...
sudo go run cmd/ctr/main.go run --rm --runtime "$(pwd)/../rund/bin/containerd-shim-rund-v1" ghcr.io/slonopotamus/macos-jail/ventura:latest my_container echo "Hello from macOS container ^_^"
----
